              ...
              <div style={{ width: 316.99, position: "relative" }}>
                {on1 ? (
                  ...
                  >
                    ...
                    necessary assistance to ensure your safety and the safety of
                    your passengers.
                  </div>
                ) : (
                  ""
                ...
                >
                  ...
                  >
                    What type of support does Buga Travels provide to drivers in
                    case of emergencies?
                  </div>
                  <div
                    onClick={() => {
              ...
              <div style={{ width: 316.99, position: "relative" }}>
                {on2 ? (
                  ...
                  >
                    ...
                    and report any issues they may encounter during a ride. This
                    feedback helps us monitor and address any concerns related
            ...
            >
              <div style={{ width: 316.99, position: "relative" }}>
                {on4 ? (
                  ...
                  >
                    Yes, as a Buga Travels driver, you are expected to adhere to
                    our driver guidelines and local transportation regulations.
                    These guidelines ensure a safe and reliable experience for
                    both drivers and passengers. It's important to review and
                    comply with these rules to maintain your partnership with
                    Buga Travels
                  </div>
                ) : (
                  ""
              ...
              <div style={{ width: 316.99, position: "relative" }}>
                {on5 ? (
                  ...
                  >
                    ...
                    indicating the days and hours you are willing to accept ride
                    requests.
                  </div>
                ) : (
                  ""
            ...
            >
              <div style={{ width: 316.99, position: "relative" }}>
                {on6 ? (
                  ...
                  >
                    If a passenger cancels a ride, you will be notified through
                    the app, and the ride will be marked as canceled. In such
                    cases, you may receive a cancellation fee depending on the
                    specific circumstances and our cancellation policy.
                  </div>
                ) : (
                  ""
                )}
              ...
              <div style={{ width: 316.99, position: "relative" }}>
                {on7 ? (
                  ...
                  >
                    ...
                    seriously. If a dispute arises, we encourage both parties to
                    provide detailed information through the app or by
              ...
              <div style={{ width: 316.99, position: "relative" }}>
                {on8 ? (
                  ...
                  >
                    ...
                    transportation services for university students and shuttle
                    services to and from the airport. Additional services beyond
                    the scope of passenger transportation may not be supported
                    at this time
                  </div>
                ) : (
                  ""
                ...
                >
                  ...
                  >
                    Can I use Buga Travels to offer additional services, such as
                    courier deliveries?
                  </div>
                  <div
                    onClick={() => {
            ...
            >
              <div style={{ width: 316.99, position: "relative" }}>
                {on9 ? (
                  ...
                  >
                    Buga Travels employs a dynamic pricing model that takes into
                    account factors such as distance, time, and demand. This
                    helps ensure fair compensation for drivers and reasonable
                    pricing for passengers, considering market conditions and
                    operational costs.
                  </div>
                ) : (
                  ""
            ...
            >
              <div style={{ width: 316.99, position: "relative" }}>
                {on10 ? (
                  ...
                  >
                    Buga Travels operates in multiple cities across Nigeria and
                    Africa. If you are approved as a driver, you may have the
                    opportunity to drive in different cities where Buga Travels
                    operates, expanding your potential to serve a wider range of
                    riders.
                  </div>
                ) : (
                  ""
...
export default DriverPageMobile;
